 ...
 * @author ALENCAR
 */
public class RelatorioAPagar {

    private InterfacePool pool;

    public RelatorioAPagar(InterfacePool pool) {
        this.pool = pool;
    }
    ...
    public void gerarRelatorio(String dataInicial, String dataFinal, String codigo_categoria) {
        ...
        try {
            String sqlSelect = "SELECT\n" +
                ...
                "    VALOR_A_PAGAR,\n" +
                "    VALOR_PAGO,\n" +
                "    (CASE WHEN (VALOR_A_PAGAR - VALOR_PAGO) < 0 THEN 0 ELSE\n" +
                "    VALOR_A_PAGAR - VALOR_PAGO END ) AS DEBITO,\n" +
                "    DATA_PAGAMENTO,\n" +
                "    C.NOME_USUARIO,\n" +
            ...
            if (totalRegistro > 0) {
                InputStream caminho = getClass().getResourceAsStream("rel_contas_a_pagar.jasper");                                
